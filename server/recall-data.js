export const demoRecall = {
  ...
  affectedUnits: [
    { id: "S-4381", owner: "Priya Menon", city: "Bengaluru", state: "In use", risk: "Urgent", path: ["RB-2107", "VoltCore V2 battery", "S-4381", "Priya Menon"] },
    { id: "S-4492", owner: "Arjun Rao", city: "Hyderabad", state: "In use", risk: "Urgent", path: ["RB-2107", "VoltCore V2 battery", "S-4492", "Arjun Rao"] },
    { id: "S-4568", owner: "Kavya Shah", city: "Chennai", state: "In use", risk: "Priority", path: ["RB-2107", "VoltCore V2 battery", "S-4568", "Kavya Shah"] },
    { id: "S-4620", owner: "Aman Singh", city: "Pune", state: "In use", risk: "Priority", path: ["RB-2107", "VoltCore V2 battery", "S-4620", "Aman Singh"] }
  ]
};
